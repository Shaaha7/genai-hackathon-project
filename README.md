...
```bash
git clone https://github.com/Shaaha-7/genai-hackathon-project.git
...
├── README.md                    # This file
└── NON_TECHNICAL_OVERVIEW.md    # Plain-English explanation for non-technical readers
```
...
Built for CST4625 Generative AI — Hackathon Submission
